<x-admin::layouts>
    ...
    @pushOnce('scripts')
        <script>
            (() => {
                const quoteSelect = document.getElementById('crm-billing-quote');
                const form = document.getElementById('crm-flexible-billing-form');
                ...
                const amountInput = document.getElementById('crm-billing-amount');
                const methodSelect = document.getElementById('crm-billing-method');
                const percentageInput = document.getElementById('crm-billing-percentage');
                const percentageWrap = document.getElementById('crm-percentage-wrap');
                const dpInputs = document.getElementById('crm-dp-inputs');
                const message = document.getElementById('crm-eligibility-message');
                const submitButton = document.getElementById('crm-generate-button');
                const loading = document.getElementById('crm-billing-loading');
                ...
                const render = (preserveDpAmount = true) => {
                    ...
                    submitButton.disabled = ! eligible || ! validAmount;
                ...
                quoteSelect.addEventListener('change', loadSummary);

                form.querySelectorAll('input[name="billing_type"]').forEach((input) => {
                    input.addEventListener('change', () => render(false));
                });
