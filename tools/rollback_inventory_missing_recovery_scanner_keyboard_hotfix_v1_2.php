...
const TITLE = 'ROLLBACK INVENTORY MISSING RECOVERY SCANNER HOTFIX V1.2';
...
try {
    ...
    if (! is_file($pointer)) {
        fail('Pointer backup V1.2 tidak ditemukan.');
    }
    ...
    if (
        ...
        fail('Lokasi backup V1.2 tidak valid.');
    }
